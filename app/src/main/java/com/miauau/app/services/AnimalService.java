...
public class AnimalService {
  ...
  public AnimalEntity create(AnimalRequest response, MultipartFile image) throws IOException {
    ...
    AnimalEntity animal = AnimalEntity.builder()
        ...
        .vaccinationApplicationDate(response.vaccinationApplicationDate())
        .antiFleasApplicationDate(response.antiFleasApplicationDate())
        .dewormingApplicationDate(response.dewormingApplicationDate())
